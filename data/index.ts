...
export const gridItems = [
  ...
  },
  {
    ...
    description: "Posibilities are endless",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  {
    id: 4,
    title: "A team of tech enthusiasts with a passion for development.",
    description: "",
...

  {
    id: 5,
    title:
      "We leverage the latest and most secure tools to deliver exceptional results.",
  ...
  {
    id: 6,
    title: "Have an idea and need development?",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
...
export const team = [
  ...
  {
    id: 3,
    title: "Adriana Sobota",
    des: "Full Stack Developer. Crafting seamless, user-centric web experiences & turning ideas into interactive realities",
    img: "/Profile-1.png",
    iconLists: ["/re.svg", "/tail.svg", "/ts.svg", "/three.svg", "/c.svg"],
...
export const workExperience = [
  {
    ...
    desc: "Independently developed a web-based platform using React.js, enhancing business functionalities.",
  ...
  },
  {
    ...
    desc: "Connected the companie's pipedrive to independently developed dashboard saving 25% of employee time",
    className: "md:col-span-2", // change to md:col-span-2
    thumbnail: "/exp3.svg",
  },
  {
